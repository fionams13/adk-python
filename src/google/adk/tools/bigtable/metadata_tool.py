...
def list_instances(project_id: str, credentials: Credentials) -> list[str]:
  ...
  Returns:
      list[str]: List of the Bigtable instance ids present in the project.
  """
  try:
    ...
    return [instance.instance_id for instance in instances_list]
...
def list_tables(
  ...
  Returns:
      list[str]: List of the tables ids present in the instance.
  """
  try:
    bt_client = client.get_bigtable_admin_client(
        project=project_id, credentials=credentials
